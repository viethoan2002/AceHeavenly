    ...
    public static class DirectionPresets
    {
        public static List<DirectionId> GetPresetByMode(SwipeDetectionMode mode)
        {
            switch (mode)
            {
                ...
                case SwipeDetectionMode.Custom:
                    return CustomSidesPreset();
        ...
        public static List<DirectionId> CustomSidesPreset()
        {
            return new List<DirectionId>
            {
                new DirectionId(DirectionId.ID_UP, Vector3.up + Vector3.right),
                new DirectionId(DirectionId.ID_DOWN, Vector3.down + Vector3.left),
                new DirectionId(DirectionId.ID_LEFT, Vector3.up + Vector3.left),
                new DirectionId(DirectionId.ID_RIGHT, Vector3.down + Vector3.right),
            };
        }
